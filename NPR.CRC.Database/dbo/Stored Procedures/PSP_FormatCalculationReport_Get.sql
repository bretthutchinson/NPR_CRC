...
--[PSP_FormatCalculationReport_Get] '8:00 AM', '2:00 PM', 'Y', 'Y', 'Y' ,'Y' ,'Y', 'Y', 'Y', 1, 2014, 2, 'Y', null, '|AM|,|FM|', 'Y'
...
--AND
 ...
 --(sc.Status=''Accepted'')
	...
	DECLARE @TempResult2 TABLE(Station VARCHAR(100),StateName VARCHAR(50),City VARCHAR(100),MemberStatusName VARCHAR(100),Metro INT, DMA INT, CLS DECIMAL(8,2) , ECL DECIMAL(8,2),ENT DECIMAL(8,2),
								...
								FLK DECIMAL(8,2),JZZ DECIMAL(8,2),NWS DECIMAL(8,2),POP DECIMAL(8,2),TRG DECIMAL(8,2),WLD DECIMAL(8,2), nx int)
