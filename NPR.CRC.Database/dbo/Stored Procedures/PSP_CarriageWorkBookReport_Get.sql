CREATE PROCEDURE [dbo].[PSP_CarriageWorkBookReport_Get]
(
...
--[PSP_CarriageWorkBookReport_Get] 5, '1, 2, 3' , 2013, '|AM|, |FM|', 'N', null, null
	...
	ELSE
		BEGIN
			...
			SELECT 
			 ...
			 FROM @Temp
			 group by station, programname, DaysOfWeek, starttime, endtime
			 ORDER BY
				ProgramName, st, city, station
...
--[PSP_CarriageWorkBookReport_Get] 3, '1, 2, 3' , 2013, '|AM|, |FM|', 'N', null, null