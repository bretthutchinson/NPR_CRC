CREATE Procedure [dbo].[DT_PERegularToScheduleProgram2]
AS
BEGIN
	...
	SELECT @minPERegularId = MIN(crc3.dbo.PERegularPartition2.PERegularID) FROM crc3.dbo.PERegularPartition2;
	SELECT @maxRERegularId = MAX(crc3.dbo.PERegularPartition2.PERegularID) FROM crc3.dbo.PERegularPartition2;
