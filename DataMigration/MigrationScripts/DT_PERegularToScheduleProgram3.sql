CREATE Procedure [dbo].[DT_PERegularToScheduleProgram3]
AS
BEGIN
	...
	SELECT @minPERegularId = MIN(crc3.dbo.PERegularPartition3.PERegularID) FROM crc3.dbo.PERegularPartition3;
	SELECT @maxRERegularId = MAX(crc3.dbo.PERegularPartition3.PERegularID) FROM crc3.dbo.PERegularPartition3;
