CREATE Procedure [dbo].[DT_PERegularToScheduleProgram4]
AS
BEGIN
	...
	SET @BatchSet = 0;
	SET @BatchSize = 300000;
	
	SELECT @minPERegularId = MIN(crc3.dbo.PERegularPartition4.PERegularID) FROM crc3.dbo.PERegularPartition4;
	SELECT @maxRERegularId = MAX(crc3.dbo.PERegularPartition4.PERegularID) FROM crc3.dbo.PERegularPartition4;
