...
{
    public class ImportDocumentViewModel
    {
        ...
        public List<ImportStationViewModel> Results { get; set; }

        public ImportDocumentViewModel()
        {
        ...
        internal sealed class CsvFileExtensionsAttribute : ValidationAttribute
        {
            protected override ValidationResult IsValid(object value, ValidationContext validationContext)
            {
                ...
                var model = (ImportDocumentViewModel)validationContext.ObjectInstance;
